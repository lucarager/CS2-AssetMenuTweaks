...
All tweaks can be toggled from the game's Options screen, or directly from buttons added to the asset menu itself.
...
### Donations
If you'd like to support my modding work, you can do so on [Ko-fi](https://ko-fi.com/lucadevdesign). It's hugely appreciated!
